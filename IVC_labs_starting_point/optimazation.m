...
Frame_new_rec{1} = ictRGB2YCbCr(Frame1_RGB);
...
for i = 1:20
    ...
    Prediction_error = (Frame_new_YCbCr - Frame_sender_rec);% error between sender reconstrected Frame and true Frame
...
Frame2_rec = SSD_rec(Frame1_YCbCr_ict, mv_indices);%reconstructed Frame2 with mv and Frame1 YCbCr
Prediction_error_1 = ictYCbCr2RGB(Frame2_rec - Frame2_YCbCr_ict);%get the error of reconstructed Frame2 and true Frame2 YCbCr
